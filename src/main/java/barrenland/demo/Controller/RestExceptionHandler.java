...
import barrenland.demo.Exception.ExceptionResponse;
import barrenland.demo.Exception.IntegerPraserException;
import barrenland.demo.Exception.ValueNotFoundException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * @parame the ValueNotFoundException
     */
     ...
     * @param request the WebRequest
     * @return the ExceptionResponse
     * @parame the NumberFormatException
     */
    @ExceptionHandler(NumberFormatException.class)
    public final ResponseEntity<ExceptionResponse> handleNumberFormatException(ValueNotFoundException ex,
                                                                                WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse();
        exceptionResponse.setStatus(HttpStatus.BAD_REQUEST);
        exceptionResponse.setErrorCode("400");
